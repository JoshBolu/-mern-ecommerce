...
const FeaturedProducts = ({ featuredProducts }) => {
  ...
  //   change items per page based on window size
  useEffect(() => {
    const handleResize = () => {
                  ...
                  <div className=" bg-gray-800 bg-opacity-10 backdrop-blur-sm rounded-lg shadow-lg overflow-hidden h-full transition-all duration-300 hover:shadow-xl border border-emerald-500/30">
                    ...
                    <div className="p-4">
                      ...
                      <button
                        ...
                        className="w-full bg-emerald-600 text-white font-semibold py-2 px-4 rounded transition-colors duration-300 flex items-center justify-center"
                      >
