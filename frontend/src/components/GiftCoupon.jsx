...
const GiftCoupon = () => {
  ...
  console.log("gift coupon", coupon);
  ...
  return (
    ...
    >
      <div className="space-y-4">
        ...
        <motion.button
          type="button"
          className="flex w-full item-center justify-center rounded-lg bg-emerald-600 px-5 py-2.5 font-medium text-white hover:bg-emerald-700 focus:outline-none focus:ring-4 focus:ring-emerald-300"
